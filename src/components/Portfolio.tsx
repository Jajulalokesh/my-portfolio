  ...
  const projects = [
    {
      ...
      liveUrl: "https://pocket-shop-czcv.onrender.com/",
      githubUrl: "https://github.com/Jajulalokesh/pocket-shop"
    },
    {
      ...
      liveUrl: "https://jajulalokesh.github.io/phishiing-email-analyzer/",
      githubUrl: "https://github.com/Jajulalokesh/phishiing-email-analyzer"
    }
  ];
              ...
              <Card className="glass-card p-8">
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <span> Located in Hyderabad</span>
                  </div>
                </div>
